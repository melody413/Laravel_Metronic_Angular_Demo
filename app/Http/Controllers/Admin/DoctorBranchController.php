...
class DoctorBranchController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->input('saveNew'))
            return redirect(route('admin.doctor_branch.index', ['id' => $row->doctor_id]))->with($redirctMsg);
    ...
    public function delete($id)
    {
        ...
        return redirect(route('admin.doctor_branch.index', ['id' => $doctorId]))->with([
    ...
    public function toggleActive($id, Request $request)
    {
        ...
        return redirect(route('admin.doctor_branch.index', ['id' => $row->doctor_id ]))->with([
