    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Edit prescription template - {{$template->name}}</h4>
            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-group-custom">
                            <textarea id="advice" required="required">{{$template->advice}}</textarea>
                    ...
                    <div class="col-md-3">
                        <div class="form-group-custom">
                            <input type="text" id="templateName" value="{{$template->name}}" required="required"/>
                            <label class="control-label">Template Name</label><i class="bar"></i>
                        </div>
                        <div class="form-group-custom">
                            <textarea id="note" required="required">{{$template->note}}</textarea>
            ...
            <button type="button" id="updateTemplate" class="btn btn-block btn-lg btn-primary waves-effect waves-light">Update Template</button>
...
@section('extra-js')
    ...
    <script>
        $(document).ready(function () {
           $.get('{{url('/api/template-details/'.$template->id)}}',function (data) {
               var _drugs = [];
