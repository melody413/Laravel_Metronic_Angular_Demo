    ...
    <tr {{ classTag(config('tablelist.template.table.tr.class'), config('tablelist.template.table.thead.options-bar.tr.class')) }}>
        <td {{ classTag(config('tablelist.template.table.td.class'), config('tablelist.template.table.thead.options-bar.td.class')) }}
            ...
            <div class="row">
                ...
                <div {{ classTag('rows-number-selector hidden', config('tablelist.template.table.thead.options-bar.rows-number-selector.item.class')) }}>
                ...
                {{-- search bar --}}
                <div {{ classTag('search-bar-', config('tablelist.template.table.thead.options-bar.search-bar.item.class')) }} style="height: 25px;">
                        ...
                        <form role="form" method="GET" action="{{ $table->getRoute('index') }}">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control text-left"
                                       ...
                                       placeholder="Search ...."
                                       {{ trans('tablelist::tablelist.thead.search') }} {{ $table->getSearchableTitles() }}"
