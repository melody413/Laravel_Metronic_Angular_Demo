...
<div class="col-sm-12">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            {!! Form::select('country_id', $countries ,null , ['class' => 'form-control bsGetAjaxData', 'id'=> 'bsCountryId']) !!}
        </div>
    ...
    <div class="iform-group">
        ...
        <div class="col-sm-11">
            {!! Form::select('city_id', [] ,null , ['class' => 'form-control', 'id' => 'bsCityies', 'data-val' => isset($item->city_id)?$item->city_id:'']) !!}
        </div>
