    ...
    @slot('content')
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover dataTable dataTableAjax" searching="true" data-url="{{ route('admin.area.index') }}">
                    <thead>
                    <tr>
                        ...
                        <th name="name" >Country</th>
                        <th name="name" >City</th>
