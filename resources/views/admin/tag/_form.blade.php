...
<div class="input-group input-group-lg">
    ...
    <div class="form-line">
        <select name="module_name" id="module_name" class="form-select form-select-solid">
...
<div class="col-sm-12">
    ...
    <div class="tag-categories" class="col-sm-12" @if(isset($item) && $item->module_name != "medicine") hidden @endif>
        <h2 class="tag-categories"><b>Category : </b></h2>
        <br>
        <div class="col-sm-10 tag tag-align tag-categories">
            <div class="demo-checkbox">
                <div class="row">
