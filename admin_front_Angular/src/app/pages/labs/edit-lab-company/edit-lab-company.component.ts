...
@Component({
  selector: 'app-edit-lab-company',
  templateUrl: './edit-lab-company.component.html',
  styleUrls: ['./edit-lab-company.component.scss']
})
export class EditLabCompanyComponent {
  desItems = [{ title: 'Description' }];
   ...
   constructor(private http: HttpClient, private crd: ChangeDetectorRef,private router: Router, private route: ActivatedRoute,) {}
    ...
    ngOnInit(): void {
      ...
      this.http.get<any>(environment.apiUrl + "lab_company/edit/" + this.pharmacy_co_id)
          .subscribe((response)=>{
            ...
            if(this.pharmacy_company.image) this.image_name = environment.url+ "uploads/lab_companies/" +this.pharmacy_company.image;
